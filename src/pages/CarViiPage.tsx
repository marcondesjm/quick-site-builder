...
import nfcCarStickerImage from "@/assets/nfc-car-sticker.png";
import nfcCarStickerRoundImage from "@/assets/nfc-car-sticker-round.png";
...
const CarViiPage = () => {
  ...
  const currentStickerImage = selectedStickerType === "round" ? nfcCarStickerRoundImage : nfcCarStickerImage;
  ...
  const visitorUrl = propertyAccessCode 
    ? `${window.location.origin}/call/${encodeURIComponent(propertyAccessCode.code)}?property=${encodeURIComponent(selectedProperty?.name || 'Veículo')}&source=carvii`
    : `${window.location.origin}/call/demo?property=Veículo&source=carvii`;
  ...
  const handleCopy = () => {
    ...
    toast({
      title: "Link copiado!",
      description: "O link CarVii foi copiado para a área de transferência.",
    });
  };
    ...
    if (navigator.share) {
      try {
        await navigator.share({
          title: `CarVii - ${selectedProperty?.name || 'Veículo'}`,
          text: `Toque seu celular para ligar para o proprietário do veículo`,
          url: visitorUrl,
        });
      } catch (e) {
        handleCopy();
  ...
  const handleDownloadSticker = () => {
    ...
    if (!ctx) {
      ...
      link.download = `carvii-${stickerTypeLabel}-${selectedProperty?.name || 'veiculo'}-${size?.dimensions || '10x5cm'}.png`;
    ...
    img.onload = () => {
      ...
      toast({
        ...
        description: `Adesivo CarVii ${stickerTypeLabel} ${size?.dimensions || ''} salvo com sucesso.`,
      });
  ...
  if (propertiesLoading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-indigo-600/20 via-background to-background flex items-center justify-center">
        <motion.div
          animate={{ rotate: 360 }}
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-600/20 via-background to-background">
      {/* Header */}
      ...
      <main className="container mx-auto px-4 py-6 max-w-2xl">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-500/10 rounded-full mb-4">
            ...
            <span className="text-sm font-medium text-indigo-600 dark:text-indigo-400">
              QR Code / NFC para Carros
            </span>
          </div>
          <h2 className="text-2xl font-bold mb-2">
            Proteja seu carro com CarVii
          </h2>
          <p className="text-muted-foreground">
            Videochamadas seguras para contato em emergências e estacionamento
          </p>
        </motion.div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Receba uma chamada se seu carro estiver bloqueando alguém
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Seja notificado imediatamente se algo acontecer com seu veículo
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Seu número de celular permanece protegido e em segurança
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-medium">Assistência na Estrada</p>
                  <p className="text-sm text-muted-foreground">
                    Qualquer pessoa pode entrar em contato para ajudar
                  </p>
                </div>
              </div>
            </div>
        ...
        <Card className="mb-6 overflow-hidden">
          <CardHeader className="text-center pb-2">
            <CardTitle className="flex items-center justify-center gap-2">
              <Wifi className="h-5 w-5 text-indigo-500 rotate-45" />
              Adesivo CarVii
            </CardTitle>
            <CardDescription>
              Baixe o adesivo e cole no para-brisa ou retrovisor do seu carro
            </CardDescription>
          </CardHeader>
          <CardContent className="flex flex-col items-center">
            ...
            <div className="flex gap-2 mb-6 w-full max-w-xs">
              ...
              >
                <div className="w-12 h-6 mx-auto mb-1 bg-gradient-to-r from-blue-900 to-indigo-500 rounded" />
              ...
              >
                <div className="w-8 h-8 mx-auto mb-1 bg-gradient-to-br from-blue-900 to-indigo-500 rounded-full" />
            ...
            >
              <img
                ...
                alt="Adesivo CarVii NFC"
                className={`${selectedStickerType === "round" ? "w-80 rounded-full" : "w-80 rounded-2xl"} h-auto shadow-2xl shadow-indigo-500/30`}
              />
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex justify-center">
                    ...
                    >
                      ...
                      />
                      <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 bg-indigo-600 text-white text-xs px-2 py-0.5 rounded-full whitespace-nowrap">
        ...
        <Card className="mb-6 border-purple-500/30">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <Nfc className="h-5 w-5 text-purple-500" />
              Programar Tag NFC
            </CardTitle>
            <CardDescription>
              Grave o link CarVii em uma tag NFC para colar no veículo
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            {nfcSupported && (
              <Button
                ...
                disabled={nfcWriting}
                className="w-full gap-2 bg-gradient-to-r from-purple-500 to-indigo-500 hover:from-purple-600 hover:to-indigo-600 text-white"
                size="lg"
              >
                {nfcWriting ? (
                  <>
        ...
        {/* Instructions */}
        <Card className="bg-gradient-to-br from-muted/30 to-muted/10 mb-6">
          <CardHeader>
          ...
          <CardContent>
            <ol className="space-y-3 text-sm">
              <li className="flex items-start gap-3">
                ...
                <span>Baixe o adesivo CarVii no tamanho desejado</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="flex-shrink-0 w-6 h-6 rounded-full bg-indigo-500 text-white flex items-center justify-center text-xs font-bold">
                  2
                </span>
                <span>Imprima em adesivo transparente ou branco</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="flex-shrink-0 w-6 h-6 rounded-full bg-indigo-500 text-white flex items-center justify-center text-xs font-bold">
                  3
              ...
              <li className="flex items-start gap-3">
                ...
                <span>Aplique no para-brisa, retrovisor ou painel do carro</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="flex-shrink-0 w-6 h-6 rounded-full bg-indigo-500 text-white flex items-center justify-center text-xs font-bold">
                  5
                </span>
                <span>Pessoas podem tocar ou escanear para ligar para você!</span>
              </li>
            </ol>
          </CardContent>
        </Card>
            ...
            <AnimatePresence>
              {showAddLink && (
                ...
                >
                  ...
                  <div className="flex gap-2">
                    <Button onClick={handleAddPurchaseLink} className="flex-1 bg-indigo-600 hover:bg-indigo-700">
                      Salvar
                    </Button>
                ...
                purchaseLinks.map((link) => (
                  ...
                  >
                    ...
                    <Button
                      ...
                      className="shrink-0 text-indigo-600 hover:text-indigo-700 hover:bg-indigo-100"
                    >
